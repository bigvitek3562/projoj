...
function showList(){
  if(!selectedIngredients.empty){
    ...
    $("#search_buttonDiv").html("<input style=\"position:absolute; bottom:0px;\" class=\"search_button\" type=\"button\" id=\"searchBTN\" onclick='requestRecipes();' value=\"Найти!\"/>");
    else $("#search_buttonDiv").html("<input style=\"position:absolute; bottom:0px;\" class=\"search_button\" type=\"button\" id=\"searchBTN\" value=\"Найти!\" disabled/>");
    var otpstring = "";
...
<html lang="ru">
  ...
  <div class="left_side">
    ...
    <div id="search_buttonDiv"><input style="position:absolute; bottom:0px;"class="search_button" type="button" id="searchBTN" value="Найти!" disabled/></div>
  </div>
